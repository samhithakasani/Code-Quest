...
import { Code2, Mail, Lock, Eye, EyeOff, Zap } from 'lucide-react';
import './Auth.css';
...
export default function Login() {
  ...
  const fillDemo = () => {
    setForm({ email: 'guest@student.com', password: 'password123' });
  };
  ...
  const fillEmailAsPassword = () => {
    setForm({ email: 'test@example.com', password: 'test@example.com' });
  };
        ...
        <div className="auth-left">
          <div className="auth-left-content">
            ...
            <div className="demo-btns">
              ...
              <button className="demo-btn demo-btn-student" onClick={() => fillDemo()}>Student Demo</button>
              <button className="demo-btn demo-btn-admin" onClick={() => fillAdmin()}>Admin Access</button>
              <button className="demo-btn demo-btn-email" onClick={() => fillEmailAsPassword()}>Email as Password</button>
            </div>
          </div>
        </div>
        <div className="auth-right">
          <div className="auth-form-wrap">
            ...
            <div className="auth-hint">
              💡 <strong>Tip:</strong> Try using your email as password, or click the quick access buttons!
            </div>
