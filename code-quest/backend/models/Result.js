...
const AnswerSchema = new mongoose.Schema({
  ...
  correctAnswer: { type: String }, // Store the correct answer for result display
  explanation: { type: String }, // Store explanation for result display
});

const ResultSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true },
  paperSetId: { type: mongoose.Schema.Types.ObjectId, ref: 'PaperSet', required: true },
  quizId: { type: mongoose.Schema.Types.ObjectId, ref: 'Quiz' },
  attemptNumber: { type: Number, default: 1 }, // Track which attempt this is
  language: { type: String, required: true }, // Language used for this attempt
